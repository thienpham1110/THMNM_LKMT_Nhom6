...
namespace BUS
{
    public class SanPhamBUS
    {
        ...
        public void showFromGridviewToCBO(string id, int id_thuonghieu, ComboBox cboNhom, ComboBox cboLoai,ComboBox cboThuongHieu)
        {
            ...
            thuonghieu b = SanPhamDAO.Instance.findThuongHieu(id_thuonghieu);
            if (b != null)
            {
        ...
        public void showComboboxChanged(DataGridView data, ComboBox cboNhomSP, ComboBox cboLoai, ComboBox cboThuonghieu)
        {
            ...
            if (nsp != null)
            {
                ...
                foreach (thuonghieu b in SanPhamDAO.Instance.getListThuongHieu().Where(x => x.id_nhom == nsp.id_nhom))
                {
        ...
        {
            cbo.DataSource = DAO.SanPhamDAO.Instance.getNhomSP();
